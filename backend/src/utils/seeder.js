...
async function seedDatabase() {
    try {
        ...
        const authorityAreasToSeed = [
            { companyName: 'DNCC (Dhaka North City Corporation)', name: 'Dhaka North', latitude: 23.796780, longitude: 90.408002, radius: 12.0 }, // Expanded to cover Uttara
            { companyName: 'DSCC (Dhaka South City Corporation)',  name: 'Dhaka South', latitude: 23.724371, longitude: 90.409020, radius: 8.0 }, // Expanded
            ...
            { companyName: 'DESCO (Dhaka Electric Supply Company)', name: 'Uttara', latitude: 23.876022, longitude: 90.379263, radius: 4.0 }, // Expanded        
            { companyName: 'DPDC (Dhaka Power Distribution Company)', name: 'Dhaka South', latitude: 23.724371, longitude: 90.409020, radius: 8.0 }, // Expanded        
            { companyName: 'DoE (Department of Environment)', name: 'Dhaka', latitude: 23.812794, longitude: 90.414865, radius: 20.0 }, // Expanded        
            { companyName: 'DWASA (Dhaka Water Supply & Sewerage Authority)', name: 'Dhaka', latitude: 23.812794, longitude: 90.414865, radius: 20.0 }, // Expanded
            { companyName: 'GCC (Gazipur City Corporation)', name: 'Gazipur', latitude: 23.991012, longitude: 90.386507, radius: 10.0 }, // Expanded
            { companyName: 'Gazipur Palli Bidyut Samity-1', name: 'Gazipur', latitude: 23.991012, longitude: 90.386507, radius: 10.0 } // Expanded
        ];
